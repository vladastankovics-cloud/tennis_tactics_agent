...
- **Automate Supabase migrations**: Create a script to automatically generate Supabase migration SQL from SQLite database_service.dart changes. This would prevent manual migration creation and reduce sync errors.
- **Add previous matches context to AI advice**: Include history of previous matches against the same opponent in the AI system prompt for better tactical recommendations.
- **H2H with opponent**: Show head-to-head record (wins/losses) against a specific opponent.
- **Use Groq for chats and Gemini for advice**: Split AI providers - Groq for chat conversations, Gemini for tactical advice.
